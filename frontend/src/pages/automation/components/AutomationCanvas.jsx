...
//Each node sits a little below where its incoming arrow actually lands
//(GAP), so the card's edge never covers the arrowhead
const POSITIONS = [
  { x: 20, y: 35 },
  { x: 420, y: 145 },
  { x: 20, y: 255 },
...
const CONNECTOR_PATHS = [
  "M 150 105 V 110 Q 150 117 157 117 H 543 Q 550 117 550 124 V 130",
  "M 550 215 V 220 Q 550 227 543 227 H 157 Q 150 227 150 234 V 240",
  "M 150 325 V 330 Q 150 337 157 337 H 543 Q 550 337 550 344 V 350",
];
...
const AutomationCanvas = () => (
  <div
    className="rounded-md border h-full border-gray-200 p-4 sm:p-6"
    style={{
  ...
  >
    <div className="flex flex-col gap-y-4 h-fit">
      ...
      <div
        className="relative mx-auto hidden h-auto w-full max-w-4xl xl:block xl:h-full"
